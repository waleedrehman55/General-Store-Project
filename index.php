    ...
    <section class="py-5 overflow-hidden">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          $stmt = $conn->prepare("SELECT id, name, image FROM categories");
          if ($stmt->execute()) {
          ...
          <div class="col-md-12">
            ...
            <div class="swiper-wrapper">
              <?php foreach ($category_items as $cat): ?>
                <a href="products.php?category=<?= $cat['id'] ?>" class="nav-link category-item swiper-slide">
                  <img src="images/<?= $cat['image'] ?>" width="40" height="40" alt="<?= $cat['name'] ?>">
              ...
              <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a href="?slug=fruits-veges" class="nav-link text-uppercase fs-6" id="nav-fruits-tab" data-bs-toggle="tab" data-bs-target="#nav-fruits">Fruits & Veges</a>
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                <div class="col">
                  <div class="product-item">
                   ...
                   <figure class="pro_img_container">
                    <a href="product-details.php?id=<?= $product['id'] ?>" title="<?= $product['name'] ?>">
                      <img src="images/<?= $product['image'] ?>" class="tab-image" alt="<?= $product['name'] ?>">
                    </a>
                  </figure>

                    <h3><?= $product['name'] ?></h3>

                    <span class="qty"><?= $product['weight'] ?? '1 Unit' ?></span>
                    <span class="rating">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                      ...
                      <?php if (isset($product['stock']) && $product['stock'] > 0): ?>
                        <a href="add-to-cart.php?id=<?= $product['id'] ?>" style="font-size: 14px; text-decoration: none;">
